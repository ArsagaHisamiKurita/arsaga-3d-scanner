...
const Demo03 = () => {
  ...
  useEffect(() => {
    ...
    const url = "../rounge-with-camera-press.glb";
    ...
    <>
      ...
      <div className='relative h-[10000px]'>
        ...
        <div className='relative px-12 py-16 w-[40%]'>
          <div className='bg-white p-3 font-bold md:text-xl text-base'>このデモはカメラが固定されています。<br/>上下にスクロールをするとカメラが決められた軌道を移動します。</div>
          <div className='mt-[100vh] bg-white p-3 font-bold md:text-xl text-base'>カメラの軌道はBlenderで予め設定してモデルに書き出してThree.jsで適用しています。</div>
          <div className='mt-[100vh] bg-white p-3 font-bold md:text-xl text-base'>実際にオフィスを回遊しているような体験を目指しました。</div>
          <div className='mt-[100vh] bg-white p-3 font-bold md:text-xl text-base'>まだまだ課題は多くラウンジ全てを3Dスキャンしようとすると</div>
          <div className='mt-[100vh] bg-white p-3 font-bold md:text-xl text-base'>適正の測定距離は5mと書いてあったので</div>
          <div className='mt-[100vh] bg-white p-3 font-bold md:text-xl text-base'>かなり精度が落ちました。</div>
          <div className='mt-[100vh] bg-white p-3 font-bold md:text-xl text-base'>今回はiphone15proで試してみたので、</div>
          <div className='mt-[100vh] bg-white p-3 font-bold md:text-xl text-base'>今後の3Dスキャン精度の技術の向上に期待です。</div>
